  ...
  const tenants = [
    {
      tenantId: "trusthome",
      appName: "TrustHome",
      apiKey: process.env.TRUSTHOME_API_KEY || "",
      apiSecret: process.env.TRUSTHOME_API_SECRET || "",
    ...
    },
    {
      ...
      apiKey: process.env.DRIVER_CONNECT_API_KEY || "",
      apiSecret: process.env.DRIVER_CONNECT_API_SECRET || "",
    ...
    },
    {
      tenantId: "the-void",
      appName: "THE VOID",
      apiKey: process.env.THE_VOID_API_KEY || "",
      apiSecret: process.env.THE_VOID_API_SECRET || "",
    ...
    },
    {
      tenantId: "trustgolf",
      appName: "Trust Golf",
      apiKey: process.env.TRUSTGOLF_API_KEY || "",
      apiSecret: process.env.TRUSTGOLF_API_SECRET || "",
    ...
    },
    {
      tenantId: "trustbook",
      appName: "TrustBook",
      apiKey: process.env.TRUSTBOOK_API_KEY || "",
      apiSecret: process.env.TRUSTBOOK_API_SECRET || "",
