...
const DEFAULT_SLIDES: OnboardingSlide[] = [
  ...
  },
  {
    ...
    tips: [
      ...
      "Select multiple files for bulk export as a zip",
    ],
    image: imgBrowse,
  },
  {
    ...
    title: "Preview & Play",
    description: "Tap any file to open the media viewer. Play videos and audio, view images full-screen with zoom, and preview documents \u2014 all right inside the app.",
    tips: [
      "Videos and audio play directly in the viewer",
      "Scroll-wheel zoom, pinch-to-zoom, and double-click to zoom images",
  ...
  },
  {
    ...
    title: "Edit & Enhance",
    description: "Use the built-in editors to crop images, trim audio, cut video clips, add text overlays, and more. Save your edits as new files so you never lose the original.",
    tips: [
      "Image editor: crop, rotate, filters, adjustments, zoom/pan canvas",
      "Eyedropper tool, watermark, layer panel, and visual history",
      "Audio editor: trim, adjust volume, and effects",
      "Video editor: trim, text overlays, custom thumbnails",
    ],
    image: imgEdit,
  },
  {
